...
; CHECK-NEXT:    vmov r1, s2
; CHECK-NEXT:    vmov r2, s0
; CHECK-NEXT:    adds.w r12, r2, r1
; CHECK-NEXT:    adc r2, r3, #0
...
; CHECK-NEXT:    vmov.u8 r5, q3[4]
; CHECK-NEXT:    vmov.32 q0[0], r5
; CHECK-NEXT:    vmov.u8 r5, q3[5]
