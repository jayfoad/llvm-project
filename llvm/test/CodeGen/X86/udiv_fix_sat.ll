...
; X64-NEXT:    movdqa {{.*#+}} xmm8 = [8589934591,8589934591]
; X64-NEXT:    pand %xmm8, %xmm4
; X64-NEXT:    movq %xmm4, %rcx
; X64-NEXT:    movdqa %xmm0, %xmm5
; X64-NEXT:    punpckhdq {{.*#+}} xmm5 = xmm5[2],xmm9[2],xmm5[3],xmm9[3]
; X64-NEXT:    paddq %xmm5, %xmm5
...
; X64-NEXT:    punpcklqdq {{.*#+}} xmm7 = xmm7[0],xmm4[0]
; X64-NEXT:    movdqa {{.*#+}} xmm5 = [9223372039002259456,9223372039002259456]
; X64-NEXT:    movdqa %xmm7, %xmm4
; X64-NEXT:    pxor %xmm5, %xmm4
; X64-NEXT:    movdqa {{.*#+}} xmm10 = [9223372043297226751,9223372043297226751]
; X64-NEXT:    movdqa %xmm10, %xmm6
; X64-NEXT:    pcmpgtd %xmm4, %xmm6
; X64-NEXT:    pshufd {{.*#+}} xmm3 = xmm6[0,0,2,2]
; X64-NEXT:    pcmpeqd %xmm10, %xmm4
; X64-NEXT:    pshufd {{.*#+}} xmm2 = xmm4[1,1,3,3]
; X64-NEXT:    pand %xmm3, %xmm2
; X64-NEXT:    pshufd {{.*#+}} xmm4 = xmm6[1,1,3,3]
