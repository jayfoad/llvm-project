...
; GFX8-NEXT:    s_load_dword s0, s[0:1], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_bfe_i32 s5, s2, 0x80000
...
; GFX8-NEXT:    s_and_b32 s1, s6, s5
; GFX8-NEXT:    v_ashrrev_i16_e64 v3, 8, s2
; GFX8-NEXT:    s_bfe_i32 s2, s3, 0x80000
; GFX8-NEXT:    v_ashrrev_i16_e64 v5, 8, s3
; GFX8-NEXT:    s_and_b32 s3, s6, s4
; GFX8-NEXT:    v_mov_b32_e32 v7, s1
; GFX8-NEXT:    s_and_b32 s2, s6, s2
; GFX8-NEXT:    s_and_b32 s0, s6, s0
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mad_u32_u24 v2, s3, v7, v2
