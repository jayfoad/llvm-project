...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot4_i32_i8 v2, s2, s3, v0
...
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s3
; GFX10-DL-NEXT:    s_load_dword s3, s[6:7], 0x0
; GFX10-DL-NEXT:    s_bfe_i32 s6, s2, 0x80008
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DL-NEXT:    s_bfe_i32 s2, s2, 0x80000
; GFX10-DL-NEXT:    v_ashrrev_i16_e64 v2, 8, s3
; GFX10-DL-NEXT:    s_bfe_i32 s3, s3, 0x80000
; GFX10-DL-NEXT:    v_and_b32_e32 v5, s2, v0
; GFX10-DL-NEXT:    v_and_b32_e32 v4, s3, v0
; GFX10-DL-NEXT:    v_ashrrev_i16_e64 v3, 8, s4
; GFX10-DL-NEXT:    s_bfe_i32 s4, s4, 0x80000
; GFX10-DL-NEXT:    s_bfe_i32 s6, s5, 0x80000
; GFX10-DL-NEXT:    v_and_b32_e32 v8, s4, v0
; GFX10-DL-NEXT:    v_and_b32_e32 v7, s6, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s0
; GFX10-DL-NEXT:    v_lshl_or_b32 v2, v2, 16, v4
; GFX10-DL-NEXT:    v_lshl_or_b32 v4, v11, 16, v5
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v4, v2, v4
; GFX10-DL-NEXT:    v_add_nc_u32_sdwa v2, v4, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
