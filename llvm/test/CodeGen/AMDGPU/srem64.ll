...
; GCN-NEXT:    v_mul_lo_u32 v9, v4, v8
; GCN-NEXT:    v_mul_hi_u32 v10, v4, v11
...
; GCN-NEXT:    v_addc_u32_e32 v10, vcc, v14, v12, vcc
; GCN-NEXT:    v_mul_lo_u32 v12, v5, v11
; GCN-NEXT:    v_mul_hi_u32 v11, v5, v11
; GCN-NEXT:    v_add_i32_e32 v9, vcc, v12, v9
; GCN-NEXT:    v_addc_u32_e32 v9, vcc, v10, v11, vcc
...
; GCN-IR-NEXT:    v_add_i32_e32 v1, vcc, v6, v1
...
; GCN-NEXT:    v_mul_lo_u32 v6, s6, v0
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v4, v7
; GCN-NEXT:    v_mul_hi_u32 v5, v0, v6
; GCN-NEXT:    v_mul_lo_u32 v7, v0, v4
...
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; GCN-NEXT:    v_addc_u32_e32 v3, vcc, v3, v6, vcc
...
; GCN-NEXT:    v_addc_u32_e32 v10, vcc, v12, v13, vcc
; GCN-NEXT:    v_mul_lo_u32 v5, v6, v5
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v4, v9
; GCN-NEXT:    v_addc_u32_e32 v4, vcc, v10, v14, vcc
...
; GCN-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GCN-NEXT:    v_mul_hi_u32 v5, s4, v2
...
; GCN-IR-NEXT:    s_ashr_i32 s4, s2, 30
...
; GCN-NEXT:    v_mad_f32 v0, -v2, s2, v0
...
; GCN-IR-NEXT:    v_mad_f32 v0, -v2, s2, v0
...
; GCN-IR-NEXT:    v_trunc_f32_e32 v2, v2
; GCN-IR-NEXT:    v_cvt_i32_f32_e32 v4, v2
