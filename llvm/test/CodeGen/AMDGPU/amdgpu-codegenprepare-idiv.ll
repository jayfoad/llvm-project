...
; GCN-NEXT:    v_mul_hi_u32 v1, s5, v1
; GCN-NEXT:    v_mul_f32_e32 v2, s12, v3
...
; GCN-NEXT:    v_mul_f32_e32 v3, s12, v4
...
; GCN-NEXT:    s_mov_b32 s6, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i32 s0, s12, 31
; GCN-NEXT:    s_add_i32 s1, s12, s0
; GCN-NEXT:    s_xor_b32 s12, s1, s0
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s12
; GCN-NEXT:    s_ashr_i32 s2, s13, 31
; GCN-NEXT:    s_sub_i32 s3, 0, s12
; GCN-NEXT:    s_add_i32 s1, s13, s2
; GCN-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GCN-NEXT:    s_xor_b32 s13, s1, s2
...
; GCN-NEXT:    s_add_i32 s3, s8, s1
; GCN-NEXT:    s_xor_b32 s3, s3, s1
; GCN-NEXT:    v_mul_f32_e32 v1, s16, v1
; GCN-NEXT:    v_mul_hi_u32 v2, v0, v2
; GCN-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GCN-NEXT:    s_xor_b32 s8, s1, s0
...
; GCN-NEXT:    v_sub_i32_e32 v3, vcc, s3, v3
...
; GCN-NEXT:    s_xor_b32 s1, s3, s2
; GCN-NEXT:    s_ashr_i32 s3, s14, 31
; GCN-NEXT:    v_subrev_i32_e32 v3, vcc, s12, v0
; GCN-NEXT:    s_add_i32 s8, s14, s3
; GCN-NEXT:    v_cmp_le_u32_e32 vcc, s12, v0
; GCN-NEXT:    s_xor_b32 s9, s8, s3
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v3, vcc
; GCN-NEXT:    v_add_i32_e32 v1, vcc, v2, v1
; GCN-NEXT:    v_cvt_f32_u32_e32 v2, s9
; GCN-NEXT:    v_mul_hi_u32 v1, s1, v1
; GCN-NEXT:    v_subrev_i32_e32 v3, vcc, s12, v0
; GCN-NEXT:    v_cmp_le_u32_e32 vcc, s12, v0
...
; GCN-NEXT:    v_subrev_i32_e32 v3, vcc, s13, v1
; GCN-NEXT:    s_sub_i32 s0, 0, s9
...
; GCN-NEXT:    s_ashr_i32 s3, s15, 31
; GCN-NEXT:    s_add_i32 s8, s15, s3
; GCN-NEXT:    s_ashr_i32 s0, s10, 31
; GCN-NEXT:    s_xor_b32 s3, s8, s3
; GCN-NEXT:    s_add_i32 s1, s10, s0
; GCN-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
...
; GCN-NEXT:    v_rcp_iflag_f32_e32 v3, v3
; GCN-NEXT:    v_subrev_i32_e32 v1, vcc, s2, v1
; GCN-NEXT:    v_mul_lo_u32 v2, v2, s9
; GCN-NEXT:    v_mul_f32_e32 v3, s16, v3
; GCN-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GCN-NEXT:    v_sub_i32_e32 v2, vcc, s1, v2
; GCN-NEXT:    v_subrev_i32_e32 v4, vcc, s9, v2
; GCN-NEXT:    v_cmp_le_u32_e32 vcc, s9, v2
; GCN-NEXT:    s_sub_i32 s1, 0, s3
; GCN-NEXT:    v_cndmask_b32_e32 v2, v2, v4, vcc
; GCN-NEXT:    v_mul_lo_u32 v4, s1, v3
; GCN-NEXT:    s_ashr_i32 s1, s11, 31
; GCN-NEXT:    s_add_i32 s2, s11, s1
; GCN-NEXT:    s_xor_b32 s2, s2, s1
; GCN-NEXT:    v_mul_hi_u32 v4, v3, v4
; GCN-NEXT:    v_subrev_i32_e32 v5, vcc, s9, v2
; GCN-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; GCN-NEXT:    v_mul_hi_u32 v3, s2, v3
; GCN-NEXT:    v_cmp_le_u32_e32 vcc, s9, v2
; GCN-NEXT:    v_cndmask_b32_e32 v2, v2, v5, vcc
; GCN-NEXT:    v_xor_b32_e32 v2, s0, v2
; GCN-NEXT:    v_mul_lo_u32 v3, v3, s3
; GCN-NEXT:    v_subrev_i32_e32 v2, vcc, s0, v2
; GCN-NEXT:    v_sub_i32_e32 v3, vcc, s2, v3
; GCN-NEXT:    v_subrev_i32_e32 v4, vcc, s3, v3
...
; GCN-NEXT:    v_subrev_i32_e32 v3, vcc, s1, v3
; GCN-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; GCN-NEXT:    s_endpgm
  %r = srem <4 x i32> %x, %y
  store <4 x i32> %r, <4 x i32> addrspace(1)* %out
