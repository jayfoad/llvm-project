...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_bfe_i32 s7, s0, 0x40000
; GFX8-NEXT:    s_lshr_b32 s4, s1, 12
; GFX8-NEXT:    s_lshr_b32 s5, s0, 12
; GFX8-NEXT:    s_bfe_i32 s9, s0, 0x40004
; GFX8-NEXT:    s_bfe_i32 s11, s0, 0x40008
; GFX8-NEXT:    s_bfe_i32 s6, s1, 0x40000
...
; GFX8-NEXT:    s_bfe_i32 s13, s0, 0x40010
; GFX8-NEXT:    v_and_b32_e32 v4, s2, v4
; GFX8-NEXT:    v_and_b32_e32 v5, s2, v5
; GFX8-NEXT:    s_bfe_i32 s15, s0, 0x40014
; GFX8-NEXT:    s_bfe_i32 s12, s1, 0x40010
; GFX8-NEXT:    v_mov_b32_e32 v8, s13
; GFX8-NEXT:    s_bfe_i32 s17, s0, 0x40018
; GFX8-NEXT:    s_bfe_i32 s14, s1, 0x40014
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_i32 s7, s0, 0x40000
; GFX9-NEXT:    s_lshr_b32 s4, s1, 12
; GFX9-NEXT:    s_lshr_b32 s5, s0, 12
; GFX9-NEXT:    s_bfe_i32 s9, s0, 0x40004
; GFX9-NEXT:    s_bfe_i32 s11, s0, 0x40008
; GFX9-NEXT:    s_bfe_i32 s6, s1, 0x40000
...
; GFX9-NEXT:    s_bfe_i32 s13, s0, 0x40010
; GFX9-NEXT:    v_and_b32_e32 v4, s2, v4
; GFX9-NEXT:    v_and_b32_e32 v5, s2, v5
; GFX9-NEXT:    s_bfe_i32 s15, s0, 0x40014
; GFX9-NEXT:    s_bfe_i32 s12, s1, 0x40010
; GFX9-NEXT:    v_mov_b32_e32 v8, s13
; GFX9-NEXT:    s_bfe_i32 s17, s0, 0x40018
; GFX9-NEXT:    s_bfe_i32 s14, s1, 0x40014
...
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    s_bfe_i32 s7, s0, 0x40000
; GFX9-DL-NEXT:    s_lshr_b32 s4, s1, 12
; GFX9-DL-NEXT:    s_lshr_b32 s5, s0, 12
; GFX9-DL-NEXT:    s_bfe_i32 s9, s0, 0x40004
; GFX9-DL-NEXT:    s_bfe_i32 s11, s0, 0x40008
; GFX9-DL-NEXT:    s_bfe_i32 s6, s1, 0x40000
...
; GFX9-DL-NEXT:    s_bfe_i32 s13, s0, 0x40010
; GFX9-DL-NEXT:    v_and_b32_e32 v4, s2, v4
; GFX9-DL-NEXT:    v_and_b32_e32 v5, s2, v5
; GFX9-DL-NEXT:    s_bfe_i32 s15, s0, 0x40014
; GFX9-DL-NEXT:    s_bfe_i32 s12, s1, 0x40010
; GFX9-DL-NEXT:    v_mov_b32_e32 v8, s13
; GFX9-DL-NEXT:    s_bfe_i32 s17, s0, 0x40018
; GFX9-DL-NEXT:    s_bfe_i32 s14, s1, 0x40014
...
; GFX8-NEXT:    flat_load_ushort v2, v[0:1]
; GFX8-NEXT:    s_load_dword s1, s[4:5], 0x0
; GFX8-NEXT:    v_lshlrev_b16_e64 v4, 12, s0
...
; GFX8-NEXT:    v_ashrrev_i16_e32 v4, 12, v4
; GFX8-NEXT:    s_lshr_b32 s7, s1, 12
; GFX8-NEXT:    s_lshr_b32 s14, s0, 12
...
; GFX8-NEXT:    s_lshr_b32 s11, s0, 24
...
; GFX8-NEXT:    s_lshr_b32 s2, s1, 28
; GFX8-NEXT:    s_lshr_b32 s10, s0, 28
; GFX8-NEXT:    v_ashrrev_i16_e32 v9, 12, v9
; GFX8-NEXT:    v_ashrrev_i16_e32 v16, 12, v16
; GFX8-NEXT:    v_lshlrev_b16_e64 v11, 12, s2
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0
; GFX7-NEXT:    s_mov_b32 s12, 0xffff
; GFX7-NEXT:    s_load_dword s0, s[8:9], 0x0
; GFX7-NEXT:    s_load_dword s1, s[10:11], 0x0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_bfe_i32 s8, s0, 0x40000
; GFX7-NEXT:    s_bfe_i32 s16, s1, 0x40000
; GFX7-NEXT:    s_bfe_i32 s17, s1, 0x40004
; GFX7-NEXT:    s_bfe_i32 s18, s1, 0x40008
; GFX7-NEXT:    s_bfe_i32 s19, s1, 0x4000c
; GFX7-NEXT:    s_bfe_i32 s20, s1, 0x40010
; GFX7-NEXT:    s_bfe_i32 s21, s1, 0x40014
; GFX7-NEXT:    s_bfe_i32 s22, s1, 0x40018
; GFX7-NEXT:    s_ashr_i32 s1, s1, 28
...
; GFX7-NEXT:    s_bfe_i32 s13, s0, 0x40010
; GFX7-NEXT:    v_mov_b32_e32 v4, s20
; GFX7-NEXT:    s_bfe_i32 s14, s0, 0x40014
; GFX7-NEXT:    v_mov_b32_e32 v3, s21
; GFX7-NEXT:    s_bfe_i32 s15, s0, 0x40018
...
; GFX7-NEXT:    v_and_b32_e32 v9, s2, v9
...
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX7-NEXT:    v_and_b32_e32 v2, s12, v2
; GFX7-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GFX7-NEXT:    v_and_b32_e32 v5, s12, v5
; GFX7-NEXT:    v_or_b32_e32 v1, v2, v1
...
; GFX8-NEXT:    s_lshr_b32 s9, s0, 12
; GFX8-NEXT:    s_lshr_b32 s10, s0, 8
; GFX8-NEXT:    s_lshr_b32 s15, s1, 4
; GFX8-NEXT:    s_lshr_b32 s16, s1, 12
...
; GFX8-NEXT:    v_and_b32_e32 v5, s2, v9
