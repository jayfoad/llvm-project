...
; GFX9-NEXT:    v_mul_f32_e32 v9, v7, v1
; GFX9-NEXT:    v_trunc_f32_e32 v9, v9
; GFX9-NEXT:    v_cvt_u32_f32_e32 v10, v9
; GFX9-NEXT:    v_mad_f32 v7, -v9, v0, v7
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[2:3], |v7|, v0
; GFX9-NEXT:    v_mov_b32_e32 v8, s7
; GFX9-NEXT:    v_addc_co_u32_e64 v7, s[2:3], 0, v10, s[2:3]
; GFX9-NEXT:    v_mul_lo_u32 v7, v7, s5
