...
; GFX9-NEXT:    v_mul_lo_u32 v11, v9, v6
; GFX9-NEXT:    v_mul_lo_u32 v10, v8, v7
; GFX9-NEXT:    v_mul_hi_u32 v12, v8, v6
; GFX9-NEXT:    v_mul_lo_u32 v13, v8, v6
; GFX9-NEXT:    v_add3_u32 v10, v12, v10, v11
; GFX9-NEXT:    v_mul_hi_u32 v11, v6, v13
; GFX9-NEXT:    v_mul_lo_u32 v12, v6, v10
; GFX9-NEXT:    v_mul_hi_u32 v15, v6, v10
; GFX9-NEXT:    v_mul_lo_u32 v16, v7, v13
...
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, v16, v11
; GFX9-NEXT:    v_mov_b32_e32 v11, 0
; GFX9-NEXT:    v_addc_co_u32_e32 v13, vcc, v15, v13, vcc
...
; GFX9-NEXT:    v_addc_co_u32_e32 v12, vcc, v14, v12, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v10, vcc, v7, v12, s[4:5]
; GFX9-NEXT:    v_mul_lo_u32 v13, v8, v10
; GFX9-NEXT:    v_mul_hi_u32 v15, v8, v6
; GFX9-NEXT:    v_mul_lo_u32 v9, v9, v6
; GFX9-NEXT:    v_mul_lo_u32 v8, v8, v6
; GFX9-NEXT:    v_add_u32_e32 v7, v7, v12
; GFX9-NEXT:    v_add3_u32 v9, v15, v13, v9
; GFX9-NEXT:    v_mul_hi_u32 v15, v10, v8
; GFX9-NEXT:    v_mul_lo_u32 v16, v10, v8
; GFX9-NEXT:    v_mul_hi_u32 v8, v6, v8
; GFX9-NEXT:    v_mul_lo_u32 v17, v6, v9
; GFX9-NEXT:    v_mul_hi_u32 v13, v10, v9
; GFX9-NEXT:    v_mul_lo_u32 v10, v10, v9
; GFX9-NEXT:    v_mul_hi_u32 v9, v6, v9
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v8, v17
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, v14, v9, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v16, v8
; GFX9-NEXT:    v_addc_co_u32_e32 v8, vcc, v9, v15, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, v13, v11, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v8, v10
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, v14, v9, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v7, vcc, v7, v9, s[4:5]
...
; GFX9-NEXT:    v_mul_hi_u32 v12, v9, v6
; GFX9-NEXT:    v_mul_hi_u32 v13, v9, v7
...
; GFX9-NEXT:    v_mul_hi_u32 v15, v1, v7
; GFX9-NEXT:    v_mul_lo_u32 v7, v1, v7
; GFX9-NEXT:    v_add_co_u32_e32 v10, vcc, v13, v10
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, v12, v6, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v10, vcc, v15, v11, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, v14, v10, vcc
...
; GFX9-NEXT:    v_mul_lo_u32 v11, v8, v6
; GFX9-NEXT:    v_mul_hi_u32 v6, v8, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v15, vcc, v13, v15, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v11, v10
...
; GFX9-NEXT:    v_mul_hi_u32 v14, v9, v8
; GFX9-NEXT:    v_mul_lo_u32 v8, v9, v8
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, v12, v11
; GFX9-NEXT:    v_mul_lo_u32 v12, v9, v7
; GFX9-NEXT:    v_mul_hi_u32 v7, v9, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v16, vcc, v15, v16, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, v12, v11
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, v16, v7, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, v14, v13, vcc
...
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, v12, v13, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v4, v6
...
; GFX9-NEXT:    v_mul_hi_u32 v15, v4, v10
; GFX9-NEXT:    v_mul_lo_u32 v16, v7, v13
; GFX9-NEXT:    v_mul_hi_u32 v13, v7, v13
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, v11, v12
; GFX9-NEXT:    v_mul_hi_u32 v12, v7, v10
...
; GFX9-NEXT:    v_addc_co_u32_e64 v10, vcc, v7, v12, s[4:5]
; GFX9-NEXT:    v_mul_lo_u32 v13, v8, v10
; GFX9-NEXT:    v_mul_hi_u32 v15, v8, v4
...
; GFX9-NEXT:    v_mul_hi_u32 v15, v10, v8
; GFX9-NEXT:    v_mul_lo_u32 v16, v10, v8
; GFX9-NEXT:    v_mul_hi_u32 v8, v4, v8
; GFX9-NEXT:    v_mul_lo_u32 v17, v4, v9
; GFX9-NEXT:    v_mul_hi_u32 v13, v10, v9
; GFX9-NEXT:    v_mul_lo_u32 v10, v10, v9
; GFX9-NEXT:    v_mul_hi_u32 v9, v4, v9
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v8, v17
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, v14, v9, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v16, v8
; GFX9-NEXT:    v_addc_co_u32_e32 v8, vcc, v9, v15, vcc
