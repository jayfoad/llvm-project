...
; GFX10-DL-NEXT:    s_load_dword s3, s[6:7], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot2_i32_i16 v2, s3, s2, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s0
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s1
; GFX10-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
...
; GFX10-DL-NEXT:    s_load_dword s3, s[0:1], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_ashr_i32 s4, s2, 16
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s3
; GFX10-DL-NEXT:    s_load_dword s3, s[6:7], 0x0
; GFX10-DL-NEXT:    s_sext_i32_i16 s2, s2
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_ashr_i32 s5, s3, 16
...
; GFX10-DL-NEXT:    s_load_dword s4, s[6:7], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_and_b32 s6, s4, s2
...
; GFX10-DL-NEXT:    s_and_b32 s2, s2, s6
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_lshr_b32 s5, s3, 16
; GFX10-DL-NEXT:    s_and_b32 s3, s3, s6
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, s5, s4, v0
...
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s2, s5, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s0
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s1
; GFX10-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
...
; GFX10-DL-NEXT:    s_load_dword s3, s[0:1], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_sext_i32_i16 s4, s2
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s3
; GFX10-DL-NEXT:    s_load_dword s3, s[6:7], 0x0
; GFX10-DL-NEXT:    s_ashr_i32 s2, s2, 16
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_sext_i32_i16 s5, s3
