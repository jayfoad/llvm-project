...
; GCN-NEXT:    v_mul_lo_u32 v10, v5, v9
...
; GCN-NEXT:    v_addc_u32_e32 v11, vcc, v15, v13, vcc
; GCN-NEXT:    v_mul_lo_u32 v13, v6, v12
; GCN-NEXT:    v_mul_hi_u32 v12, v6, v12
; GCN-NEXT:    v_add_i32_e32 v10, vcc, v13, v10
; GCN-NEXT:    v_addc_u32_e32 v10, vcc, v11, v12, vcc
...
; GCN-NEXT:    v_sub_i32_e32 v9, vcc, v1, v8
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, v0, v11
; GCN-NEXT:    v_subb_u32_e64 v9, s[4:5], v9, v3, vcc
...
; GCN-NEXT:    v_mad_f32 v2, -v2, v1, v3
...
; GCN-NEXT:    v_mul_lo_u32 v10, v6, v3
; GCN-NEXT:    v_mul_lo_u32 v9, v5, v3
...
; GCN-NEXT:    v_mul_lo_u32 v11, v4, v9
...
; GCN-NEXT:    v_sub_i32_e32 v7, vcc, 24, v8
...
; GCN-NEXT:    v_cndmask_b32_e64 v6, v9, v8, s[4:5]
...
; GCN-NEXT:    v_cndmask_b32_e64 v6, v11, v9, s[4:5]
...
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    v_lshr_b64 v[12:13], 24, v6
...
; GCN-NEXT:    v_addc_u32_e32 v4, vcc, 0, v4, vcc
; GCN-NEXT:    v_mul_hi_u32 v6, s4, v3
...
; GCN-NEXT:    v_add_i32_e32 v5, vcc, v5, v7
; GCN-NEXT:    v_sub_i32_e32 v6, vcc, 0, v5
; GCN-NEXT:    v_sub_i32_e32 v7, vcc, s4, v8
; GCN-NEXT:    v_subb_u32_e64 v6, s[4:5], v6, v1, vcc
; GCN-NEXT:    v_sub_i32_e64 v8, s[4:5], v7, v0
; GCN-NEXT:    v_subbrev_u32_e64 v6, s[4:5], 0, v6, s[4:5]
; GCN-NEXT:    v_cmp_ge_u32_e64 s[4:5], v6, v1
...
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, v3, v0
; GCN-IR-NEXT:    v_bfe_i32 v0, v0, 0, 24
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
  %x.shr = ashr i64 %x, 40
