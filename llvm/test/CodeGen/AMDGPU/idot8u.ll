...
; GFX10-DL-NEXT:    s_bfe_u32 s7, s0, 0x40008
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s4, v2
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s4, s2, 0x4000c
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s5, s6, v2
; GFX10-DL-NEXT:    s_bfe_u32 s5, s0, 0x4000c
; GFX10-DL-NEXT:    s_bfe_u32 s6, s0, 0x40014
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s7, v2
; GFX10-DL-NEXT:    v_mul_u32_u24_e64 v3, s4, s5
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x40010
...
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s4, v2
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x40018
; GFX10-DL-NEXT:    s_bfe_u32 s4, s0, 0x40018
; GFX10-DL-NEXT:    s_lshr_b32 s2, s2, 28
; GFX10-DL-NEXT:    s_lshr_b32 s0, s0, 28
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s5, s6, v2
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s4, v2
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s2, s0, v2
; GFX10-DL-NEXT:    v_and_b32_e32 v2, 15, v2
; GFX10-DL-NEXT:    global_store_byte v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
                                      <8 x i4> addrspace(1)* %src2,
...
; GFX10-DL-NEXT:    s_bfe_u32 s0, s2, 0x40004
; GFX10-DL-NEXT:    s_bfe_u32 s5, s4, 0x40004
; GFX10-DL-NEXT:    s_bfe_u32 s7, s4, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s8, s4, 0x4000c
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s6, v2
; GFX10-DL-NEXT:    s_bfe_u32 s6, s2, 0x4000c
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x40008
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s5, v2
; GFX10-DL-NEXT:    v_mul_u32_u24_e64 v3, s6, s8
; GFX10-DL-NEXT:    s_bfe_u32 s0, s2, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s5, s2, 0x40014
; GFX10-DL-NEXT:    s_bfe_u32 s6, s4, 0x40014
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s7, v2
...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_and_b32 s6, s2, 15
; GFX10-DL-NEXT:    s_bfe_u32 s9, s2, 0x40004
; GFX10-DL-NEXT:    s_and_b32 s7, s4, 15
; GFX10-DL-NEXT:    s_bfe_u32 s8, s4, 0x40004
; GFX10-DL-NEXT:    s_bfe_u32 s5, s2, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s10, s2, 0x4000c
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s6, s6, s9
; GFX10-DL-NEXT:    s_bfe_u32 s11, s4, 0x40008
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s7, s7, s8
; GFX10-DL-NEXT:    s_bfe_u32 s12, s4, 0x4000c
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s5, s5, s10
; GFX10-DL-NEXT:    s_bfe_u32 s0, s2, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s8, s4, 0x40014
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v2, s6, s7
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s1, s11, s12
; GFX10-DL-NEXT:    s_bfe_u32 s6, s2, 0x40014
; GFX10-DL-NEXT:    s_bfe_u32 s7, s4, 0x40010
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v4, s5, s1
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s0, s0, s6
...
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v4, s1, s0
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, v2, v3
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_load_dword s10, s[10:11], 0x0
; GFX7-NEXT:    buffer_load_ubyte v8, off, s[4:7], 0
; GFX7-NEXT:    s_load_dword s0, s[8:9], 0x0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_bfe_u32 s20, s10, 0x40014
; GFX7-NEXT:    s_bfe_u32 s11, s10, 0x4000c
; GFX7-NEXT:    s_lshr_b32 s18, s10, 28
; GFX7-NEXT:    s_bfe_u32 s14, s0, 0x40014
; GFX7-NEXT:    v_mov_b32_e32 v2, s20
; GFX7-NEXT:    s_bfe_u32 s15, s10, 0x40008
; GFX7-NEXT:    s_bfe_u32 s16, s10, 0x40004
; GFX7-NEXT:    s_and_b32 s17, s10, 15
; GFX7-NEXT:    s_bfe_u32 s19, s10, 0x40018
; GFX7-NEXT:    s_bfe_u32 s10, s10, 0x40010
; GFX7-NEXT:    v_mul_u32_u24_e32 v2, s14, v2
; GFX7-NEXT:    s_bfe_u32 s1, s0, 0x4000c
; GFX7-NEXT:    s_bfe_u32 s2, s0, 0x40008
; GFX7-NEXT:    s_bfe_u32 s8, s0, 0x40004
; GFX7-NEXT:    s_and_b32 s9, s0, 15
; GFX7-NEXT:    s_lshr_b32 s12, s0, 28
; GFX7-NEXT:    s_bfe_u32 s13, s0, 0x40018
; GFX7-NEXT:    s_bfe_u32 s0, s0, 0x40010
; GFX7-NEXT:    v_mov_b32_e32 v0, s10
; GFX7-NEXT:    v_mov_b32_e32 v3, s18
; GFX7-NEXT:    v_mul_u32_u24_e32 v1, s0, v0
...
; GFX7-NEXT:    v_mov_b32_e32 v3, s16
; GFX7-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX7-NEXT:    v_or_b32_e32 v1, v1, v2
; GFX7-NEXT:    v_mov_b32_e32 v2, s17
; GFX7-NEXT:    v_mul_u32_u24_e32 v3, s8, v3
; GFX7-NEXT:    v_mov_b32_e32 v4, s11
; GFX7-NEXT:    v_mul_u32_u24_e32 v2, s9, v2
; GFX7-NEXT:    v_lshlrev_b32_e32 v3, 8, v3
; GFX7-NEXT:    v_mul_u32_u24_e32 v4, s1, v4
; GFX7-NEXT:    v_or_b32_e32 v2, v2, v3
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_add_i32_e32 v2, vcc, v8, v2
; GFX7-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; GFX7-NEXT:    v_add_i32_e32 v2, vcc, v4, v2
; GFX7-NEXT:    v_add_i32_e32 v2, vcc, v5, v2
; GFX7-NEXT:    v_mad_u32_u24 v0, s0, v0, v2
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_bfe_u32 s8, s0, 0x40004
; GFX8-NEXT:    s_bfe_u32 s10, s0, 0x4000c
; GFX8-NEXT:    s_bfe_u32 s15, s1, 0x40004
; GFX8-NEXT:    s_and_b32 s16, s1, 15
; GFX8-NEXT:    s_bfe_u32 s17, s1, 0x4000c
; GFX8-NEXT:    s_bfe_u32 s4, s0, 0x40014
; GFX8-NEXT:    s_lshr_b32 s6, s0, 28
; GFX8-NEXT:    s_bfe_u32 s11, s1, 0x40014
; GFX8-NEXT:    s_bfe_u32 s12, s1, 0x40010
; GFX8-NEXT:    s_lshr_b32 s13, s1, 28
; GFX8-NEXT:    s_bfe_u32 s14, s1, 0x40018
...
; GFX8-NEXT:    s_bfe_u32 s7, s0, 0x40018
...
; GFX8-NEXT:    v_and_b32_e32 v4, s2, v9
...
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v2, s0, s1
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40008
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v3, s6, s8
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x40008
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v4, s7, s9
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v2, 8, v2
; GFX10-DL-NEXT:    s_bfe_u32 s7, s5, 0x40014
; GFX10-DL-NEXT:    s_bfe_u32 s6, s4, 0x40018
...
; GFX10-DL-NEXT:    s_lshr_b32 s4, s4, 28
; GFX10-DL-NEXT:    v_or_b32_sdwa v3, v6, v4 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX10-DL-NEXT:    v_and_b32_e32 v2, s2, v2
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v4, s1, s7
; GFX10-DL-NEXT:    s_bfe_u32 s8, s5, 0x40010
; GFX10-DL-NEXT:    s_lshr_b32 s9, s5, 28
; GFX10-DL-NEXT:    s_bfe_u32 s5, s5, 0x40018
; GFX10-DL-NEXT:    v_or_b32_e32 v3, v2, v3
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v4, 8, v4
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v6, s0, s8
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v7, s4, s9
...
; GFX10-DL-NEXT:    v_add_nc_u32_sdwa v2, v2, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:BYTE_2
; GFX10-DL-NEXT:    v_add_nc_u32_sdwa v2, v2, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_3
; GFX10-DL-NEXT:    v_or_b32_e32 v3, v4, v5
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, v2, v4
...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot8_u32_u4 v2, s3, s2, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s0
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s1
; GFX10-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
