...
; GFX10-DL-NEXT:    v_mul_u32_u24_e64 v3, s4, s6
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s5, v2
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s4, s0, 0x40010
...
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x4000c
; GFX10-DL-NEXT:    s_bfe_u32 s4, s0, 0x4000c
; GFX10-DL-NEXT:    v_mul_u32_u24_e64 v3, s1, s4
...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_and_b32 s5, s2, 15
; GFX10-DL-NEXT:    s_bfe_u32 s6, s2, 0x40004
...
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v2, s5, s7
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x4000c
; GFX10-DL-NEXT:    s_bfe_u32 s9, s4, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s6, s4, 0x4000c
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s5, s9, s6
; GFX10-DL-NEXT:    s_bfe_u32 s1, s2, 0x40014
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v4, s0, s5
...
; GFX10-DL-NEXT:    s_bfe_u32 s8, s5, 0x40004
; GFX10-DL-NEXT:    s_and_b32 s0, s4, 15
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v2, s1, s8
; GFX10-DL-NEXT:    s_and_b32 s9, s5, 15
; GFX10-DL-NEXT:    s_bfe_u32 s7, s4, 0x4000c
; GFX10-DL-NEXT:    s_bfe_u32 s8, s5, 0x4000c
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v3, s0, s9
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v4, s7, s8
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v2, 8, v2
; GFX10-DL-NEXT:    s_bfe_u32 s6, s4, 0x40008
...
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v7, s4, s1
