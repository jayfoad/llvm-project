...
; SI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[4:5]|, 0.5
; SI-NEXT:    v_bfi_b32 v1, s10, v8, v1
...
; SI-NEXT:    v_cndmask_b32_e64 v5, v1, v4, s[0:1]
; SI-NEXT:    v_mov_b32_e32 v1, s2
; SI-NEXT:    v_cndmask_b32_e64 v1, v1, 0, vcc
; SI-NEXT:    v_mov_b32_e32 v4, s8
; SI-NEXT:    v_cndmask_b32_e64 v4, v1, v4, s[0:1]
...
; CI-NEXT:    v_bfi_b32 v5, s6, v8, v4
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[2:3]|, 0.5
; CI-NEXT:    v_trunc_f64_e32 v[6:7], s[0:1]
; CI-NEXT:    v_mov_b32_e32 v4, 0
; CI-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; CI-NEXT:    v_add_f64 v[2:3], v[0:1], v[4:5]
; CI-NEXT:    v_add_f64 v[0:1], s[0:1], -v[6:7]
; CI-NEXT:    v_mov_b32_e32 v5, s1
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[0:1]|, 0.5
; CI-NEXT:    v_bfi_b32 v5, s6, v8, v5
; CI-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_u32 s0, s11, 0xb0014
; SI-NEXT:    s_add_i32 s18, s0, s7
; SI-NEXT:    s_mov_b32 s2, s6
; SI-NEXT:    s_lshr_b64 s[0:1], s[2:3], s18
; SI-NEXT:    s_brev_b32 s19, 1
; SI-NEXT:    s_andn2_b64 s[16:17], s[10:11], s[0:1]
; SI-NEXT:    s_and_b32 s0, s11, s19
; SI-NEXT:    v_mov_b32_e32 v1, s0
; SI-NEXT:    v_mov_b32_e32 v0, s17
; SI-NEXT:    v_cmp_lt_i32_e64 vcc, s18, 0
; SI-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; SI-NEXT:    v_mov_b32_e32 v1, s11
; SI-NEXT:    v_cmp_gt_i32_e64 s[0:1], s18, 51
...
; SI-NEXT:    v_add_f64 v[5:6], s[8:9], -v[0:1]
; SI-NEXT:    s_bfe_u32 s0, s15, 0xb0014
; SI-NEXT:    v_mov_b32_e32 v7, s9
; SI-NEXT:    s_add_i32 s10, s0, s7
; SI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[5:6]|, 0.5
; SI-NEXT:    v_bfi_b32 v7, s16, v12, v7
; SI-NEXT:    s_lshr_b64 s[0:1], s[2:3], s10
; SI-NEXT:    v_cndmask_b32_e32 v5, 0, v7, vcc
; SI-NEXT:    s_andn2_b64 s[8:9], s[14:15], s[0:1]
; SI-NEXT:    s_and_b32 s0, s15, s19
...
; SI-NEXT:    v_cndmask_b32_e64 v9, v5, v8, s[0:1]
; SI-NEXT:    v_mov_b32_e32 v5, s2
; SI-NEXT:    v_cndmask_b32_e64 v5, v5, 0, vcc
; SI-NEXT:    v_mov_b32_e32 v8, s12
; SI-NEXT:    v_cndmask_b32_e64 v8, v5, v8, s[0:1]
; SI-NEXT:    v_add_f64 v[10:11], s[12:13], -v[8:9]
; SI-NEXT:    v_mov_b32_e32 v5, s13
; SI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[10:11]|, 0.5
; SI-NEXT:    v_bfi_b32 v5, s16, v12, v5
; SI-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; SI-NEXT:    v_add_f64 v[4:5], v[8:9], v[4:5]
; SI-NEXT:    s_mov_b32 s7, 0xf000
...
; CI-NEXT:    v_bfi_b32 v5, s2, v12, v4
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[2:3]|, 0.5
; CI-NEXT:    v_trunc_f64_e32 v[6:7], s[8:9]
; CI-NEXT:    v_mov_b32_e32 v4, 0
; CI-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; CI-NEXT:    v_add_f64 v[2:3], v[0:1], v[4:5]
; CI-NEXT:    v_add_f64 v[0:1], s[8:9], -v[6:7]
; CI-NEXT:    v_mov_b32_e32 v5, s9
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[0:1]|, 0.5
; CI-NEXT:    v_bfi_b32 v5, s2, v12, v5
; CI-NEXT:    v_trunc_f64_e32 v[8:9], s[14:15]
; CI-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; CI-NEXT:    v_add_f64 v[0:1], v[6:7], v[4:5]
; CI-NEXT:    v_add_f64 v[5:6], s[14:15], -v[8:9]
; CI-NEXT:    v_mov_b32_e32 v7, s15
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[5:6]|, 0.5
; CI-NEXT:    v_bfi_b32 v7, s2, v12, v7
; CI-NEXT:    v_trunc_f64_e32 v[10:11], s[12:13]
; CI-NEXT:    v_cndmask_b32_e32 v5, 0, v7, vcc
; CI-NEXT:    v_add_f64 v[6:7], v[8:9], v[4:5]
; CI-NEXT:    v_add_f64 v[8:9], s[12:13], -v[10:11]
...
; SI-NEXT:    v_bfi_b32 v6, s24, v20, v6
; SI-NEXT:    s_and_b32 s2, s15, s27
; SI-NEXT:    v_cndmask_b32_e32 v13, 0, v6, vcc
; SI-NEXT:    v_mov_b32_e32 v5, s2
; SI-NEXT:    v_mov_b32_e32 v4, s9
; SI-NEXT:    v_cmp_lt_i32_e64 vcc, s10, 0
...
; SI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[6:7]|, 0.5
; SI-NEXT:    s_lshr_b64 s[2:3], s[4:5], s10
; SI-NEXT:    v_bfi_b32 v8, s24, v20, v8
; SI-NEXT:    v_add_f64 v[0:1], v[0:1], v[12:13]
; SI-NEXT:    v_cndmask_b32_e32 v13, 0, v8, vcc
; SI-NEXT:    s_andn2_b64 s[8:9], s[12:13], s[2:3]
; SI-NEXT:    s_and_b32 s2, s13, s27
; SI-NEXT:    v_add_f64 v[6:7], v[4:5], v[12:13]
; SI-NEXT:    v_mov_b32_e32 v5, s2
; SI-NEXT:    v_mov_b32_e32 v4, s9
; SI-NEXT:    v_cmp_lt_i32_e64 vcc, s10, 0
; SI-NEXT:    v_cndmask_b32_e32 v4, v4, v5, vcc
...
; SI-NEXT:    v_bfi_b32 v10, s24, v20, v10
; SI-NEXT:    s_and_b32 s2, s19, s27
; SI-NEXT:    v_cndmask_b32_e32 v13, 0, v10, vcc
...
; SI-NEXT:    v_cndmask_b32_e64 v8, v8, v13, s[2:3]
; SI-NEXT:    v_add_f64 v[13:14], s[16:17], -v[8:9]
; SI-NEXT:    s_bfe_u32 s2, s23, 0xb0014
; SI-NEXT:    v_mov_b32_e32 v15, s17
; SI-NEXT:    s_add_i32 s10, s2, s7
; SI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[13:14]|, 0.5
; SI-NEXT:    v_bfi_b32 v15, s24, v20, v15
; SI-NEXT:    s_lshr_b64 s[2:3], s[4:5], s10
; SI-NEXT:    v_cndmask_b32_e32 v13, 0, v15, vcc
; SI-NEXT:    s_andn2_b64 s[8:9], s[22:23], s[2:3]
; SI-NEXT:    s_and_b32 s2, s23, s27
; SI-NEXT:    v_add_f64 v[8:9], v[8:9], v[12:13]
; SI-NEXT:    v_mov_b32_e32 v14, s2
; SI-NEXT:    v_mov_b32_e32 v13, s9
; SI-NEXT:    v_cmp_lt_i32_e64 vcc, s10, 0
; SI-NEXT:    v_cndmask_b32_e32 v13, v13, v14, vcc
; SI-NEXT:    v_mov_b32_e32 v14, s23
; SI-NEXT:    v_cmp_gt_i32_e64 s[2:3], s10, 51
; SI-NEXT:    v_cndmask_b32_e64 v15, v13, v14, s[2:3]
; SI-NEXT:    v_mov_b32_e32 v13, s8
; SI-NEXT:    v_cndmask_b32_e64 v13, v13, 0, vcc
; SI-NEXT:    v_mov_b32_e32 v14, s22
; SI-NEXT:    v_cndmask_b32_e64 v14, v13, v14, s[2:3]
...
; SI-NEXT:    v_cmp_lt_i32_e64 vcc, s7, 0
; SI-NEXT:    v_cndmask_b32_e32 v13, v13, v16, vcc
; SI-NEXT:    v_cmp_gt_i32_e64 s[2:3], s7, 51
; SI-NEXT:    v_mov_b32_e32 v16, s21
; SI-NEXT:    v_cndmask_b32_e64 v17, v13, v16, s[2:3]
; SI-NEXT:    v_mov_b32_e32 v13, s4
; SI-NEXT:    v_cndmask_b32_e64 v13, v13, 0, vcc
; SI-NEXT:    v_mov_b32_e32 v16, s20
; SI-NEXT:    v_cndmask_b32_e64 v16, v13, v16, s[2:3]
; SI-NEXT:    v_add_f64 v[18:19], s[20:21], -v[16:17]
; SI-NEXT:    v_mov_b32_e32 v13, s21
; SI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[18:19]|, 0.5
; SI-NEXT:    v_add_f64 v[18:19], s[22:23], -v[14:15]
; SI-NEXT:    v_bfi_b32 v21, s24, v20, v13
; SI-NEXT:    v_mov_b32_e32 v13, s23
; SI-NEXT:    v_cmp_ge_f64_e64 s[2:3], |v[18:19]|, 0.5
; SI-NEXT:    v_bfi_b32 v13, s24, v20, v13
; SI-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x9
; SI-NEXT:    v_cndmask_b32_e64 v13, 0, v13, s[2:3]
; SI-NEXT:    v_add_f64 v[14:15], v[14:15], v[12:13]
; SI-NEXT:    v_cndmask_b32_e32 v13, 0, v21, vcc
...
; CI-NEXT:    s_brev_b32 s2, -2
; CI-NEXT:    v_mov_b32_e32 v18, 0x3ff00000
...
; CI-NEXT:    v_add_f64 v[2:3], s[6:7], -v[0:1]
; CI-NEXT:    v_bfi_b32 v4, s2, v18, v4
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[2:3]|, 0.5
; CI-NEXT:    v_mov_b32_e32 v6, s5
; CI-NEXT:    v_cndmask_b32_e32 v13, 0, v4, vcc
; CI-NEXT:    v_trunc_f64_e32 v[4:5], s[4:5]
; CI-NEXT:    v_add_f64 v[2:3], v[0:1], v[12:13]
; CI-NEXT:    v_add_f64 v[0:1], s[4:5], -v[4:5]
; CI-NEXT:    v_bfi_b32 v6, s2, v18, v6
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[0:1]|, 0.5
; CI-NEXT:    v_mov_b32_e32 v8, s11
; CI-NEXT:    v_cndmask_b32_e32 v13, 0, v6, vcc
; CI-NEXT:    v_trunc_f64_e32 v[6:7], s[10:11]
; CI-NEXT:    v_add_f64 v[0:1], v[4:5], v[12:13]
; CI-NEXT:    v_add_f64 v[4:5], s[10:11], -v[6:7]
; CI-NEXT:    v_bfi_b32 v8, s2, v18, v8
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[4:5]|, 0.5
; CI-NEXT:    v_trunc_f64_e32 v[4:5], s[8:9]
; CI-NEXT:    v_cndmask_b32_e32 v13, 0, v8, vcc
; CI-NEXT:    v_add_f64 v[8:9], s[8:9], -v[4:5]
; CI-NEXT:    v_mov_b32_e32 v10, s9
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[8:9]|, 0.5
; CI-NEXT:    v_trunc_f64_e32 v[8:9], s[14:15]
; CI-NEXT:    v_bfi_b32 v10, s2, v18, v10
; CI-NEXT:    v_add_f64 v[6:7], v[6:7], v[12:13]
; CI-NEXT:    v_cndmask_b32_e32 v13, 0, v10, vcc
; CI-NEXT:    v_add_f64 v[10:11], s[14:15], -v[8:9]
; CI-NEXT:    v_add_f64 v[4:5], v[4:5], v[12:13]
; CI-NEXT:    v_mov_b32_e32 v13, s15
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[10:11]|, 0.5
; CI-NEXT:    v_bfi_b32 v13, s2, v18, v13
; CI-NEXT:    v_trunc_f64_e32 v[14:15], s[12:13]
; CI-NEXT:    v_cndmask_b32_e32 v13, 0, v13, vcc
; CI-NEXT:    v_add_f64 v[10:11], v[8:9], v[12:13]
; CI-NEXT:    v_add_f64 v[8:9], s[12:13], -v[14:15]
; CI-NEXT:    v_mov_b32_e32 v13, s13
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[8:9]|, 0.5
; CI-NEXT:    v_bfi_b32 v13, s2, v18, v13
; CI-NEXT:    v_cndmask_b32_e32 v13, 0, v13, vcc
; CI-NEXT:    v_add_f64 v[8:9], v[14:15], v[12:13]
; CI-NEXT:    v_mov_b32_e32 v13, s19
; CI-NEXT:    v_trunc_f64_e32 v[16:17], s[16:17]
; CI-NEXT:    v_bfi_b32 v20, s2, v18, v13
; CI-NEXT:    v_mov_b32_e32 v13, s17
; CI-NEXT:    v_bfi_b32 v21, s2, v18, v13
; CI-NEXT:    v_add_f64 v[13:14], s[16:17], -v[16:17]
; CI-NEXT:    v_cmp_ge_f64_e64 vcc, |v[13:14]|, 0.5
; CI-NEXT:    v_trunc_f64_e32 v[14:15], s[18:19]
; CI-NEXT:    v_add_f64 v[18:19], s[18:19], -v[14:15]
; CI-NEXT:    v_cmp_ge_f64_e64 s[2:3], |v[18:19]|, 0.5
; CI-NEXT:    v_cndmask_b32_e64 v13, 0, v20, s[2:3]
; CI-NEXT:    v_add_f64 v[14:15], v[14:15], v[12:13]
; CI-NEXT:    v_cndmask_b32_e32 v13, 0, v21, vcc
; CI-NEXT:    v_add_f64 v[12:13], v[16:17], v[12:13]
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, -1
