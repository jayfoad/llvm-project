...
; MIPS32_PIC-NEXT:    addiu $sp, $sp, -32
; MIPS32_PIC-NEXT:    .cfi_def_cfa_offset 32
...
; MIPS32_PIC-NEXT:    sltu $2, $2, $4
; MIPS32_PIC-NEXT:    andi $2, $2, 1
; MIPS32_PIC-NEXT:    sw $1, 28($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    sw $4, 24($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    sw $3, 20($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    sw $5, 16($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    sw $6, 12($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    sw $7, 8($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    sw $8, 4($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    bnez $2, $BB0_6
; MIPS32_PIC-NEXT:    nop
; MIPS32_PIC-NEXT:  $BB0_1: # %entry
; MIPS32_PIC-NEXT:    lw $1, 28($sp) # 4-byte Folded Reload
; MIPS32_PIC-NEXT:    lw $2, %got($JTI0_0)($1)
; MIPS32_PIC-NEXT:    lw $3, 24($sp) # 4-byte Folded Reload
...
; MIPS32_PIC-NEXT:    lw $2, 4($sp) # 4-byte Folded Reload
; MIPS32_PIC-NEXT:    addiu $sp, $sp, 32
; MIPS32_PIC-NEXT:    jr $ra
; MIPS32_PIC-NEXT:    nop
